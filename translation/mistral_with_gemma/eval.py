...
def main():
    ...
    with torch.no_grad():
        ...
        for batch in pbar:
            ...
            for doc_id, pred_score, true_score, subject, seat_number in zip(doc_ids, pred.cpu().numpy(), target.cpu().numpy(), subjects, seat_numbers):
                ...
                predictions.append({
                    ...
                    "seat_number": seat_number.item() if hasattr(seat_number, "item") else seat_number
                })

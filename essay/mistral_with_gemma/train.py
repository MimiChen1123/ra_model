...
def main():
    ...
    essays = load_essays(args.essay_data, args.question_data)
    ...
    train_data = EssayDataset(data["train"], tokenizer)
    eval_data = EssayDataset(data["eval"], tokenizer)
    ...
    for epoch in range(args.epochs):
        ...
        for batch in pbar:
            ...
            other_feature = batch["other_feature"].cuda()
